    ...
    },
    {
      ...
      content: addressref.current == undefined ? (
        ...
        <div className="relative z-10 mt-4 w-full max-w-[45rem]">
          <div className="relative flex flex-col justify-between gap-5 overflow-hidden rounded-xl border border-[#2a3038] bg-[#151922] p-4 md:flex-row md:items-start md:gap-6 md:p-6">
    ...
    <>
      <DashboardLayout>
        {siteLoader == true && Loader == true ? (
          ...
          <section className="asset_section w-full max-w-full overflow-x-hidden px-3 pt-0 sm:px-4 md:px-0 max-sm:pt-20">
